...
An Instron universal testing machine with 100 kN load cell was used to carry out static tests. Initial tests were conducted on dummy wood specimens in order to find the approximate elastic loading range for all specimen orientations.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{experiment.eps}
        \caption{}
