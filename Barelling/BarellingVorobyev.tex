...
3D solid elements.
Geometry of the speciment was considered to be  The platens of universal testing mashine
...
The model was linear elastic. A \textit{\color {red}Add the type of mesh} mesh
...
Present work uses DSP in order to obtain the experimental strainfield, which
containes strain deata of observed area and not between two points as it is for the strain gauge. 
Another simulation was performed by \cite{Chen001}.
He has simulated the behaviour of the specimien with geometrical
imperfections on a locked heispherical seat duing the compressive experiments. 
