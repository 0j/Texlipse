...
height=6cm,width=\textwidth/3, title={b)},
%    xlabel={Temperature [\textcelsius]},
...
\begin{axis}[
name=b1,height=5cm,width=\textwidth/3,
    title={a)},
%    xlabel={Temperature [\textcelsius]},
    ylabel={Normalized Young's modulus},
    xmin=0.05, xmax=0.45,
...
\begin{axis}[legend pos=outer north east,
	name=b2,at={($(b1.east)+(1cm,0)$)},anchor=west, height=5cm, width=\textwidth/3,
    title={b)},
...
\begin{axis}[legend pos=outer north east,
	name=b3,at={($(b2.east)+(1cm,0)$)},anchor=west, height=5cm,width=\textwidth/3,
    title={c)},
%    xlabel={Temperature [\textcelsius]},
%    ylabel={Measured stiffness [Pa]},
    xmin=0.05, xmax=0.45,
...
height=4cm,width=\textwidth/3, title={b')},
    xlabel={Given Poisson's ratio [-]},
...
\begin{axis}[
	name=b5,at={($(b1.south)-(0,1.5cm)$)},anchor=north, height=4cm, width=\textwidth/3,
    title={a')},
%     xlabel={Given Poisson's ratio [-]},
   ylabel={Normalized Poisson's ratio},
    xmin=0.05, xmax=0.45,
...
height=4cm,width=\textwidth/3, title={c')},
%    xlabel={Temperature [\textcelsius]},
%    ylabel={Measured stiffness [Pa]},
    xmin=0.05, xmax=0.45,
    ymin=0.75, ymax=1.01,
...
\captionsetup{justification=centering}
\caption{a)Simulated and normalized results based on experiment of
