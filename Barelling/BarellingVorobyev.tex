...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
		...
		%     \addlegendentry{Surface area of interest}
			\addplot [thin, blue] coordinates {(0.0, 0.3) (0.28,28.0)};
			\addplot [thin, red] coordinates {(0.05, 0.3) (0.25,28.0)};
...
barrelling spread out of ``area of interest'' and therefore error is surpressed.
...
However it is more signinficant than in the second approach. This is due to the
strain is measured between two points in the center of the specimen where
``clamping'' is still dominating. Large error values for the Youngs modulus
close to the horisontal edges of simulated model are clearly visible in
