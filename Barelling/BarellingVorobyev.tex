...
\begin{description}
\item{\textit{ Barelling in Isotropic vs. Transverse-Isotropic material}}
\end{description}
...
trend is that with the larger Poisson's ratio $\nu_{12}$, the error
is larger. However the error for the istropic material is significantly larger
when factor $K=1$. The error in Young's moduli for the transverse isotropic material, 
is less in the axial direction $3$ than in transverse direction $1$ (Figure \ref{fig:isovstriso} b,c). 
...
\item What were the findings?
	...
	\color{black}
	    ...
	    add the plots}
	    \item 3 Maybe add the transverse figures for the Error plot figures(DONE)
