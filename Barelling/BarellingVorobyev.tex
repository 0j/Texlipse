...
geometry. The ASTM D-143 standard \cite{standard1997d143,
...
For rare materials such as archaeological wood (as exemplified in Figure
\ref{fig:fourgraphs} (a)), it is more convenient to use cubic samples \cite{ljungdahl2007transverse, vorobyevcharacterisation} to save material.
...
Moreover, barrelling  (as illustrated in Figure \ref{fig:fourgraphs} (b)) during
...
The purpose of the present work is to investigates the occurrence of barrelling
...
\ref{fig:fourgraphs} (c). This area of interest was chosen to represent DSP
...
measurements in the universal testing machine from the
...
applied stress, as exemplified in Figure \ref{fig:fourgraphs}(d). The choice of
strain measure is the subject of a later discussion.
...
The barrelling in cubic samples subjected to compressive testing is an phenomenon that can influence the
...
composite \cite{hyer2009stress}\end{tabular}  & \begin{tabular}{@{}c@{}}
 S2 glass reinforced  \\
epoxy \cite{hyer2009stress} \end{tabular}  
\\
