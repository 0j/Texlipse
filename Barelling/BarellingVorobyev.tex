...
Instead the load were directly applied to the top surface of the cube. 

{\color {red}Add the bottom surface, the free adges the friction, the
coeffitients, the variability of frictions}
\begin{itemize}
\color{red}
