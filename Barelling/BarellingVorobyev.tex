...
loading \cite{oldroyd1966stress}, due to the more or less restrained contact slip on the platens area, makes it difficult to assess the transverse deformations without having to resort to finite element modelling.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{BarellingEffectZoomed.png}
        \caption{}
...
\textit{Vasa} oak specimen during compressive testing including displacement field. c) Experimental strain vs.
