...
%     rotate=60,anchor=east},
    ...
    \addplot table[x=Emodgiven,y=nul	] {\emodgivread}; \label{e1}
%     \addlegendentry{$\nu$=0.05}
    \addplot table[x=Emodgiven,y=tr0.1 ] {\emodgivread}; \label{e2}
%     \addlegendentry{$\nu$=0.1}
    \addplot table[x=Emodgiven,y=trinf ] {\emodgivread}; \label{e3}
%     \addlegendentry{$\nu$=0.15}
    \addplot table[x=Emodgiven,y=iso0.1 ] {\emodgivread}; \label{e4}
%     \addlegendentry{$\nu$=0.1}
    \addplot table[x=Emodgiven,y=isoinf ] {\emodgivread}; \label{e5}
%     \addlegendentry{$\nu$=0.15}
