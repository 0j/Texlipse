...
Instead compressive load was simulated as prescribe displacement and  directly
applied perpendicularilly to the top surface of the cube in Z direction.
...
which equals to the stiffness along Z axis of the cube.
