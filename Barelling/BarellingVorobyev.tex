...
\begin{tikzpicture}
 [spy using outlines={circle,black,magnification=5,size=1cm,
 connect spies}]
...
%     rotate=60,anchor=east},
    ...
    \addplot[mark=, green!60!black, solid] table[x=Emodgiven,y=nul	]
    {\emodgivread};
    \label{e1}
%     \addlegendentry{$\nu$=0.05}
    \addplot [mark=, red,  dashed] table[x=Emodgiven,y=tr0.1 ]
    {\emodgivread}; \label{e2}
%     \addlegendentry{$\nu$=0.1}
    \addplot [mark=, pink,  dashed] table[x=Emodgiven,y=trinf ] {\emodgivread};
    \label{e3}
%     \addlegendentry{$\nu$=0.15}
    \addplot [mark=, black,,  dashdotted ] table[x=Emodgiven,y=iso0.1 ] {\emodgivread};
    \label{e4}
%     \addlegendentry{$\nu$=0.1}
    \addplot [mark=, gray,  dashdotted ] table[x=Emodgiven,y=isoinf ] {\emodgivread};
    \label{e5}
%     \addlegendentry{$\nu$=0.15}

\coordinate (spypoint) at (axis cs:3,3);
\coordinate (magnifyglass) at (axis cs:2,4);
...
($E_{1}$) in transverse-isotropic and isotropic material for spring
coefficients $K=0$ (\ref{k1}), $K=0.1$ (\ref{k2}) and $K=\infty$ (\ref{k3});\\
\color{red}{a) total area of interest, b) chosen area of interest c)
experiment.}}
