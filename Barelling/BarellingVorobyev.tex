...
Three realistic ways of measuring strain were taken into account in the simulations. These strains are a result of the imposed displacement of the opposite faces of the unit cube of 0.01, corresponding to and average strain of 1\%.  The strains measured from the simulation results are:
\begin{itemize}
...
the standard ASTM D143 (Strain gauges).
